          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-0.5">
                <label className="block text-sm font-semibold text-[#1f1b17]">
                  Password
                </label>
                <button
                  type="button"
            ...
            <div className="relative py-1">
              <div className="absolute inset-0 flex items-center">
                <span className="w-full border-t border-[#eae1db]" />
              </div>
              <div className="relative flex justify-center">
                <span className="bg-white/80 px-4 text-[11px] font-bold text-[#757683] uppercase tracking-widest">
                  or continue with
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center gap-2 py-2.5 border border-[#c5c5d3] rounded-lg hover:bg-white/80 transition-colors text-sm font-semibold text-[#1f1b17]"
              >
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuAeHrnb-2PbUIiIFQ3STq2lg9-cL8xHFQ7uoAWdYJq2dVYhlWly7nDwN_ibaie72vQeQEzd4mmEXWXV1ejrDKFyw97NeHZviIMngu67bN_H1ESdedwBYquKieYmEFnqnRvjNmdPqfA1xWDQnA4ArZa2xCkc5kMh1dtKzY6kfDCThIpt3V8qP-VmFSTmqS7Ewu5fc7CdmajbI1wNA4C_dHMYK2klaqQ-7cxQT7D7q9mk5StrCnA13eM2XgrsEVQ2F4Hsa1m_TmlNlSnq"
                  alt="Google"
                  className="w-4 h-4"
                />
                Google
